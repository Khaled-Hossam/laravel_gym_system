                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $user->name }} </td></tr><tr><th> Email </th><td> {{ $user->email }} </td></tr><tr><th> National Id </th><td> {{ $user->national_id }} </td></tr><tr><th> Password </th><td> {{ $user->password }} </td></tr><tr><th> Avatar </th><td> {{ $user->avatar }} </td></tr><tr><th> Gym Id </th><td> {{ $user->gym_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
